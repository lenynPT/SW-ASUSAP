<?php
	...
	/*================================GENERADOR DE SUMINISTRO============================================*/
		...
		public function obtenerNombrefecha_D($anio,$n_mes){
			$r_anio = $anio;
			$r_mes = "";
			if($n_mes <= 0){
				if($n_mes == 0){
		...
		public function consultaAsociado_d($query){
			$result = mainModel::execute_single_query($query);
			return $result;
		}
		public function consultar_stado_gconsumo_d(){
			/* recuperar
			*/
		...
		public function consultar_fecha_actual_d(){
		...
		public function actualizarFGConsumoController_d(){
		...
		public function insertarSuministroController_d(){
	...
	/*================================GENERADOR DE CONSUMO============================================*/
        ...
        public function listaGconsumo_d($valor){
	...
	/*================================GENERADOR DE CONSUMO============================================*/
        ...
        public function updGConsumo_d($valor,$id){
                $res=0;
            if (!empty($id)){
                $dataAd = [
                    "id" => $id,
    ...
    /*================================REGISTRAR SERVICIO  ============================================*/
        ...
        public function listaRservicio_d($valorS){
